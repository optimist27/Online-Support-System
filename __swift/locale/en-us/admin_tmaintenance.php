...
$__LANG = array (
	...
	'desc_ticketsperpass' => 'Enter the number of tickets to process in a single batch <i>(default = 100).</i><br/><br/>Due to memory and CPU usage constraints, it is not recommended that this value be higher than one hundred (100).<br/><br/><font color="cc3300">Note: During the processing of a batch, the elapsed time counter will <i>not</i> update, but the process is still running!</font>',
	// ======= END v4 LOCALES =======
	'tickets' => 'Tickets',
	...
	'totaltickets' => 'Total # of tickets in database:',
	'postsprocesed' => '# of replies processed:',
	'ticketsprocessed' => '# of tickets processed:',
