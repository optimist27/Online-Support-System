...
$__LANG = array (
	...
	'benchmarkticketpost' => 'Ticket Post',
	'benchmarkchatsurvey' => 'Chat Survey',
	'benchmarkchathistory' => 'Chat History',
	'benchmarkknowledgebase' => 'Knowledgebase',
	'benchmarkdownloads' => 'Downloads',
	'benchmarktroubleshooter' => 'Troubleshooter',
	'benchmarknews' => 'News',

	'staffvisibilitycustom' => 'Restrict rating modification to certain staff teams?',
	'desc_staffvisibilitycustom' => 'Enable this setting if you want to control which staff teams (selected below) can <strong>modify</strong> this rating.',

	'buservisibilitycustom' => 'Restrict rating to certain user groups?',
	'desc_buservisibilitycustom' => 'Enable this setting if you want to control which user groups (selected below) can <strong>view and modify</strong> this rating.',

	'bstaffvisibilitycustom' => 'Restrict rating to certain staff teams?',
	'desc_bstaffvisibilitycustom' => 'Enable this setting if you want to control which staff teams (selected below) can <strong>view</strong> this rating.',

	'isclientonly' => 'Prevent staff from setting or editing the rating?',
	'desc_isclientonly' => 'If enabled, only users will be able to set or edit this rating. Your staff users won\'t be able to modify it.',
