...
$__LANG = array (
	...
	'activitydeletebenchmark' => 'Deleted Rating: %s',
	'activityinsertbenchmark' => 'Inserted Rating: %s',
	'activityupdatebenchmark' => 'Updated Rating: %s',
	// ======= END CORE =======

	// ======= BEGIN RINGROUTE =======
	'activityupdaterrprofiles' => 'Updated RingRoute Profiles',
	// ======= END RINGROUTE =======
	...
	'activityenableparserrule' => 'Enabled Parser Rule: %s',
	'activitydisableparserrule' => 'Disabled Parser Rule: %s',
	'activityupdateparserrule' => 'Updated Parser Rule: %s',
	'activityinsertparserrule' => 'Inserted Parser Rule: %s',
	'activitydeleteparserrule' => 'Deleted Parser Rule: %s',
	'activityparserlogdelete' => 'Deleted Parser Log: %s (%s)',
	'activitydeletebreakline' => 'Deleted Breakline: %s',
	'activityinsertbreakline' => 'Inserted Breakline: %s',
	'activityupdatebreakline' => 'Updated Breakline: %s',
	'activitydeleteparserban' => 'Deleted Parser Ban: %s',
	'activityinsertparserban' => 'Inserted Parser Ban: %s',
	'activityupdateparserban' => 'Updated Parser Ban: %s',
	'activitydeletecatchallrule' => 'Deleted Catch-All Rule: %s',
	'activityinsertcatchall' => 'Inserted Catch-All Rule: %s',
	'activityupdatecatchallrule' => 'Updated Catch-All Rule: %s',
	'activitydeleteparserlooprule' => 'Deleted Parser Loop Rule: %s',
	'activityinsertparserlooprule' => 'Inserted Parser Loop Rule: %s',
	'activityupdateparserlooprule' => 'Updated Parser Loop Rule: %s',
	'activitydeleteparserloopblock' => 'Deleted Parser Loop Blockage: %s',
