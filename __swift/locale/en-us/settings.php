...
$__LANG = array (
	...
	't_allowableadvtagsattributes' => 'Allowable HTML Tags Attributes',
	'd_t_allowableadvtagsattributes' => 'If the option "Allow HTML Tags" is enabled, the following HTML tags attributes will be allowed.',
	...
	'd_ls_recordphonecalls' => 'If enabled, ' . SWIFT_PRODUCT . ' will record all the phone calls which can be played back later via staff control panel.',
	...
	't_ticketnoteresetsupdatetime' => 'Adding Ticket Note Counts as a Ticket Update',
	'd_t_ticketnoteresetsupdatetime' => 'If enabled, this setting will cause a ticket\'s last update time to be reset when a ticket note is added. For example, if you configure your helpdesk to mark tickets as overdue if they are not responded to within a certain timeframe, a ticket note will count as a ticket response and will reset the clock.',
	...
	// ======= ONSITE =======
	'ons_general_1' => 'Primary OnSite Server Settings',
	'ons_xmpphost_1' => 'XMPP Host',
	'd_ons_xmpphost_1' => 'The primary XMPP OnSite server that should be used to negotiate a P2P NAT traversal session.',
