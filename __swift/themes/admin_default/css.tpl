...
.reportdescpointer {
	...
	LEFT: 40px;
	TOP: 4px;
	BACKGROUND: URL(<{$_themePath}>images/reportdescpointer.gif);
}
...
.troubleshootercategorytitle {
	BACKGROUND: url("<{$_themePath}>images/icon_folderyellow3.gif") no-repeat 0 2px;
...
.kbcategorynew { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_newfolder_faded.gif) no-repeat; CURSOR: pointer; }
.kbcategorynew:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_newfolder.gif); }

.kbarticlenew { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_newkbarticle_faded.png) no-repeat; CURSOR: pointer; }
.kbarticlenew:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_newkbarticle.png); }

.kbarticlesearch { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_searchkbarticle_faded.png) no-repeat; CURSOR: pointer; }
.kbarticlesearch:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_searchkbarticle.png); }

.kbarticlecontainer {
	padding: 0 10px 16px 38px; border-bottom: 1px SOLID #ececec; margin: 0 0 30px 0; background: url(<{$_themePath}>images/icon_viewkbarticle.png) no-repeat 0px 1px;
}
...
.kbarticlelist .kbarticlelistitem {
	background: url(<{$_themePath}>images/icon_viewkbarticlesmall.png) no-repeat 0px 1px; min-height: 20px; PADDING: 0px 0 0 20px;
}

.kbarticlecategorylistitem {
	background: url(<{$_themePath}>images/icon_viewkbarticlesmall.png) no-repeat 0px 1px; PADDING: 0px 0 0 20px; margin-top: 8px; line-height: 1.4em; min-height: 20px;
}
...
.kbcategorytitle {
	...
	background: url(<{$_themePath}>images/icon_folderyellow3.gif) no-repeat 0px 4px; cursor: pointer; margin: 0 0 10px 0;
}
...
.viewmore { margin: 6px 0 0 0; background: url(<{$_themePath}>images/icon_viewmore.png) no-repeat; width: 16px; height: 16px; cursor: pointer; }
...
.monthholder { BACKGROUND: URL(<{$_themePath}>images/smallcalendartop.gif) no-repeat; DISPLAY: block; TEXT-ALIGN: center; VERTICAL-ALIGN: middle; PADDING: 0px; COLOR: #FFFFFF; FONT: bold 11px Verdana,Arial,Helvetica; WIDTH: 54px; HEIGHT: 22px; text-shadow:0 1px 0 rgba(112, 165, 232, 0.5); }
.monthsub { PADDING-TOP: 4px; }
.dateholder { BACKGROUND: URL(<{$_themePath}>images/smallcalendarbottom.gif) no-repeat; DISPLAY: block; TEXT-ALIGN: center; VERTICAL-ALIGN: middle; PADDING: 0px; COLOR: #555555; FONT: 10px Verdana,Arial,Helvetica; WIDTH: 54px; HEIGHT: 66px; }
...
.macrocategorynew { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_newfolder_faded.gif) no-repeat; CURSOR: pointer; }
.macrocategorynew:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_newfolder.gif); }

.macroreplynew { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_newchatballoon_dotted_faded.png) no-repeat; CURSOR: pointer; }
.macroreplynew:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_newchatballoon_dotted.png); }

.macroreplysearch { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_searchchatballoon_dotted_faded.png) no-repeat; CURSOR: pointer; }
.macroreplysearch:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_searchchatballoon_dotted.png); }

.ticketattachmentitem, .attachmentitem { padding: 4px; }
.ticketattachmentitemdelete, .attachmentitemdelete { margin-right: 4px; width: 18px; display: inline-block; background: url("<{$_themePath}>images/icon_delete.gif") no-repeat 0px 1px; height: 18px; cursor: pointer; }
...
.ticketpostcontentsbargreen span.ticketbardatefold {
	BACKGROUND: URL(<{$_themePath}>images/ticketdatefoldgreen.png) no-repeat center center;
}
...
.ticketgenerallink {
	...
	FONT-SIZE: 1em;
	FONT-WEIGHT: bold;
	BACKGROUND: URL(<{$_themePath}>images/icon_link.gif) 0px 0px no-repeat;
...
.ticketescalationpatharrow {
	HEIGHT: 16px;
	BACKGROUND: URL(<{$_themePath}>images/escalationpatharrow.gif) repeat-x 10px 0px;
}
...
{
	BACKGROUND: url(<{$_themePath}>images/settabletitlebg.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
...
{
	BACKGROUND: url(<{$_themePath}>images/slascheduleopenbg.gif) REPEAT-X TOP LEFT;
	COLOR: #FFFFFF;
	FONT: 11px Verdana, Tahoma, Helvetica;
	FONT-WEIGHT: bold;
...
{
	BACKGROUND: url(<{$_themePath}>images/slascheduleopen24bg.gif) REPEAT-X TOP LEFT;
	COLOR: #FFFFFF;
	FONT: 11px Verdana, Tahoma, Helvetica;
	FONT-WEIGHT: bold;
...
{
	BACKGROUND: url(<{$_themePath}>images/slascheduleclosedbg.gif) REPEAT-X TOP LEFT;
	COLOR: #FFFFFF;
	FONT: 11px Verdana, Tahoma, Helvetica;
	FONT-WEIGHT: bold;
...
.cannedcategorynew { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_newfolder_faded.gif) no-repeat; CURSOR: pointer; }
.cannedcategorynew:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_newfolder.gif); }

.cannedresponsenew { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_newchatballoon_dotted_faded.png) no-repeat; CURSOR: pointer; }
.cannedresponsenew:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_newchatballoon_dotted.png); }

.cannedresponsesearch { DISPLAY: inline-block; HEIGHT: 20px; WIDTH: 20px; BACKGROUND: url(<{$_themePath}>images/icon_searchchatballoon_dotted_faded.png) no-repeat; CURSOR: pointer; }
.cannedresponsesearch:hover { BACKGROUND-IMAGE: url(<{$_themePath}>images/icon_searchchatballoon_dotted.png); }
...
.treeview .hitarea {
	background: url(<{$_themePath}>images/treeview-default.gif) -64px -25px no-repeat;
	height: 16px;
	width: 16px;
	margin-left: -16px;
	float: left;
...
.treeview li { background: url(<{$_themePath}>images/treeview-default-line.gif) 0 0 no-repeat; }
.treeview li.collapsable, .treeview li.expandable { background-position: 0 -176px; }

.treeview .expandable-hitarea { background-position: -80px -3px; }

.treeview li.last { background-position: 0 -1766px }
.treeview li.lastCollapsable, .treeview li.lastExpandable { background-image: url(<{$_themePath}>images/treeview-default.gif); }
...
.swifttree span.usergroup { background: url(<{$_themePath}>images/icon_usergroup.gif) 0 0 no-repeat; }
.swifttree span.inbox { background: url(<{$_themePath}>images/icon_inbox.png) 0 0 no-repeat; }
.swifttree span.inboxfull { background: url(<{$_themePath}>images/icon_inboxdocument.png) 0 0 no-repeat; }
.swifttree span.flagged { background: url(<{$_themePath}>images/icon_flag.png) 0 0 no-repeat; }
.swifttree span.watched { background: url(<{$_themePath}>images/icon_ticketwatch.png) 0 0 no-repeat; }
.swifttree span.unassignedtickets { background: url(<{$_themePath}>images/icon_ticketunassigned.png) 0 0 no-repeat; }
.swifttree span.mytickets { background: url(<{$_themePath}>images/icon_staffuser.gif) 0 0 no-repeat; }
.swifttree span.trash { background: url(<{$_themePath}>images/icon_trashempty.png) 0 0 no-repeat; }
.swifttree span.trashfull { background: url(<{$_themePath}>images/icon_trashfull.png) 0 0 no-repeat; }
.swifttree span.date { background: url(<{$_themePath}>images/icon_calendar2.gif) 0 0 no-repeat; }
.swifttree span.yellowdot { background: url(<{$_themePath}>images/icon_yellowbigdot.gif) 0 0 no-repeat; }
.swifttree span.reddot { background: url(<{$_themePath}>images/icon_redbigdot.gif) 0 0 no-repeat; }
.swifttree span.folder { background: url(<{$_themePath}>images/icon_folderyellow3.gif) 0 0 no-repeat; }
.swifttree span.folderred { background: url(<{$_themePath}>images/icon_folderred.gif) 0 0 no-repeat; }
.swifttree span.folderfaded { background: url(<{$_themePath}>images/icon_folderyellow3faded.gif) 0 0 no-repeat; }
.swifttree span.chat { background: url(<{$_themePath}>images/icon_chatnew2.gif) 2px 2px no-repeat; }
.swifttree span.funnel { background: url(<{$_themePath}>images/icon_filter.png) 0 0 no-repeat; }
.swifttree span.news { background: url(<{$_themePath}>images/icon_news.gif) 0 0 no-repeat; }
.swifttree span.call { background: url(<{$_themePath}>images/icon_phone.gif) 0 0 no-repeat; }
.swifttree span.callinbound { background: url(<{$_themePath}>images/icon_phone_incoming.gif) 0 0 no-repeat; }
.swifttree span.calloutbound { background: url(<{$_themePath}>images/icon_phone_outgoing.gif) 0 0 no-repeat; }
.swifttree span.callmissed { background: url(<{$_themePath}>images/icon_phone_missed.gif) 0 0 no-repeat; }
.swifttree span.file { background: url(<{$_themePath}>images/icon_kbarticlesmall.png) 0 0 no-repeat; }
.swifttree span.userreport { background: url(<{$_themePath}>images/icon_report_user.png) 0 0 no-repeat; }

/* END TREEVIEW CSS */

/* BEGIN NOTE COUNTERS CSS */

/*.notecounterred   { BACKGROUND: URL(<{$_themePath}>images/icon_badge.png) no-repeat; }
.notecountergreen { BACKGROUND: URL(<{$_themePath}>images/icon_badge_green.png) no-repeat; }
.notecounteryellow { BACKGROUND: URL(<{$_themePath}>images/icon_badge_yellow.png) no-repeat; }
.notecounterpink { BACKGROUND: URL(<{$_themePath}>images/icon_badge_pink.png) no-repeat; }
.notecounterorange { BACKGROUND: URL(<{$_themePath}>images/icon_badge_orange.png) no-repeat; }
...
.uiredirectcontainer {
	BACKGROUND: #faf3e3 URL(<{$_themePath}>images/loginbg1.gif) REPEAT-X TOP LEFT; PADDING-TOP: 5px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-BOTTOM: 8px; BORDER: 1px SOLID #dcd0b7; HEIGHT: 110px;
}

.uiredirectinner {
	BACKGROUND: #fcfaf5 URL(<{$_themePath}>images/loginbg2.gif) no-repeat; HEIGHT: 100%; BORDER: 1px SOLID #efe8da; OVERFLOW: hidden;
}
...
.cpuisplitterinner {
	BACKGROUND: #FFFFFF URL(<{$_themePath}>images/renavbarsplitterbg.gif) REPEAT-Y TOP LEFT;
	WIDTH: 5px;
}
...
.restaffnavbar {
	background: #f2e7d6 url(<{$_themePath}>images/renavbarbg.gif) no-repeat bottom left;
}
...
.renavsection {
	...
	margin: 0 0 0 0;
	border: 1px solid #cabeac;
	background: #FFFFFF url(<{$_themePath}>images/renavtitlebg.gif) no-repeat top left;
	COLOR: #61718C;
	WIDTH: 100%;
	MARGIN-BOTTOM: 7px;
}
...
.loginformparent {
	BACKGROUND: #ebe1d0 URL(<{$_themePath}>images/loginbg1.gif) REPEAT-X TOP LEFT; PADDING-TOP: 5px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-BOTTOM: 5px; BORDER: 1px SOLID #afa48e; z-index: 9;
}

.loginformsub {
	BACKGROUND: #f2ebde URL(<{$_themePath}>images/loginbg2.gif) no-repeat; HEIGHT: 100%; BORDER: 1px SOLID #c9bead; OVERFLOW: hidden;
}
...
div.bubble cite {
	...
	top: 6px;
	font-style: normal;
	background: transparent url(<{$_themePath}>images/notetip.gif) no-repeat 20px 0;
	z-index: 100;
}
...
div.bubble cite.tip {
	...
	padding-top: 12px;
	top: 9px;
	background: transparent url(<{$_themePath}>images/notetip1.gif) no-repeat 40px 0;
}
...
div#note2.bubble cite.tip {
	background: transparent url(<{$_themePath}>images/notetip2.gif) no-repeat 40px 0;
}
...
div#note3.bubble cite.tip {
	background: transparent url(<{$_themePath}>images/notetip3.gif) no-repeat 40px 0;
}
...
div#note4.bubble cite.tip {
	background: transparent url(<{$_themePath}>images/notetip4.gif) no-repeat 40px 0;
}
...
div#note5.bubble cite.tip {
	background: transparent url(<{$_themePath}>images/notetip5.gif) no-repeat 40px 0;
}
...
.ac_loading {
	background: white url(<{$_themePath}>images/loadingcircle.gif) right center no-repeat;
}
...
.swifttextquickinsertdiv span {
	...
	BACKGROUND: #e1d4c3 URL(<{$_themePath}>images/menudrop_white.gif) no-repeat 1px 3px;
	WIDTH: 18px;
	HEIGHT: 22px;
	CURSOR: pointer;
}
...
.swifttextautocompleteitem {
	BACKGROUND: #f8f3eb url(<{$_themePath}>images/gridtabletitlebg.gif) REPEAT-X TOP LEFT;
	-moz-border-radius: 6px;
	-webkit-border-radius: 6px;
	COLOR: #333333;
...
.dashboardoverviewtab {
	background: transparent url(<{$_themePath}>images/icon_overview.png) no-repeat scroll 0%; padding-left: 20px; height: 16px; float: left;
}
...
.dashboardmonthholder {
	BACKGROUND: URL(<{$_themePath}>images/calendartop.gif) no-repeat; DISPLAY: block; TEXT-ALIGN: center; VERTICAL-ALIGN: middle; PADDING: 0px; COLOR: #FFFFFF; FONT: bold 11px Verdana,Arial,Helvetica; WIDTH: 74px; HEIGHT: 22px;
}
...
.dashboarddateholder {
	BACKGROUND: URL(<{$_themePath}>images/calendarbottom.gif) no-repeat; DISPLAY: block; TEXT-ALIGN: center; VERTICAL-ALIGN: middle; PADDING: 0px; COLOR: #555555; FONT: 10px Verdana,Arial,Helvetica; WIDTH: 74px; HEIGHT: 66px;
}
...
.navboxtop {
	BACKGROUND: url(<{$_themePath}>images/navboxtr.gif) no-repeat top right;
	HEIGHT: 22px;
}

.navboxtopleft {
	DISPLAY: inline;
	BACKGROUND: url(<{$_themePath}>images/navboxtl.gif) no-repeat top right;
	WIDTH: 7px;
	HEIGHT: 22px;
	FLOAT: left;
}
...
.tab li a span{
	...
	HEIGHT: 14px;
	background: url(<{$_themePath}>images/basictablayout.gif) no-repeat right -50px;
}
...
.tab li a{
	...
	z-index: 1;
	outline: none;
	background: url(<{$_themePath}>images/basictablayout.gif) no-repeat 0px -200px;
}
...
.tab a:hover{
	...
	background: #FEFFF5;
	border-color: #333333;
	background: url(<{$_themePath}>images/basictablayout.gif) no-repeat 0px -250px;
	CURSOR: hand;
	CURSOR: pointer;
}
...
.tab a:hover span {
	...
	padding-top: 5px !important;
	HEIGHT: 14px;
	background: url(<{$_themePath}>images/basictablayout.gif) no-repeat right -100px;
}

.tab a.currenttab {
	padding-left: 3px;
	background: url(<{$_themePath}>images/basictablayout.gif) no-repeat 0px -150px;
	COLOR: #333333;
	margin-top: -0.0em;
	z-index: 4;
	bottom: -1px;
...
.tab a.currenttab span {
	...
	background: url(<{$_themePath}>images/basictablayout.gif) no-repeat right 0px;
}
...
.linkedselectcontainer {
	...
	BACKGROUND: URL(<{$_themePath}>images/linkdownarrow_blue.gif) no-repeat 0 10px;
}
...
.customfieldstatictitle {
	PADDING: 0 0 0 20px;
	BACKGROUND: URL(<{$_themePath}>images/icon_customfieldstatic.gif) no-repeat 0 0;
	HEIGHT: 18px;
}
...
.tabtoolbarsub ul li a {
	BACKGROUND: #fcfaf5 url(<{$_themePath}>images/gridtoolbarbuttonbg.gif) REPEAT-X TOP LEFT;
...
.tabtoolbarsub ul li a:hover  {
	BACKGROUND: #fcfaf5 url(<{$_themePath}>images/gridtoolbaritemhover.gif) REPEAT-X TOP LEFT;
	text-decoration: none;
...
{
	BORDER: solid 0 #FFFFFF; BACKGROUND: URL(<{$_themePath}>images/button1_sprite.png) no-repeat top left; HEIGHT: 24px; WIDTH: 79px; COLOR: #000000; FONT-FAMILY: Verdana, Tahoma; FONT-SIZE: 11px; MARGIN: 0px; padding-top: 0px; padding-bottom: 2px; CURSOR: pointer;
...
{
	BORDER: solid 0 #FFFFFF; BACKGROUND: URL(<{$_themePath}>images/button2_sprite.png) no-repeat top left; HEIGHT: 24px; WIDTH: 110px; COLOR: #000000; FONT-FAMILY: Verdana, Tahoma; FONT-SIZE: 11px; MARGIN: 0px; padding-top: 4px; padding-bottom: 15px; vertical-align:middle; CURSOR: pointer;
}
...
.settabletitlerow
{
	BACKGROUND: #FFFFFF url(<{$_themePath}>images/settabletitlebg.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
	PADDING: 5px;
	CURSOR: pointer;
...
{
	BACKGROUND: #80A9EA url(<{$_themePath}>images/settabletitlebghover.gif) REPEAT-X TOP LEFT;
	COLOR: red;
	FONT: 11px Verdana, Tahoma, Helvetica;
	PADDING: 5px;
	CURSOR: pointer;
...
.tabletitlerowtitle
{
	BACKGROUND: #fcfaf4 url(<{$_themePath}>images/tabletitlerowbackground.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
...
{
	BACKGROUND: #fcfaf4 url(<{$_themePath}>images/settabletitlebg.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
	BORDER-TOP: 1px SOLID #f5f0e8;
	BORDER-BOTTOM: 1px SOLID #ddd6c7;
...
{
	BACKGROUND: url(<{$_themePath}>images/settabletitlebgdisabled.gif) REPEAT-X TOP LEFT;
	COLOR: #aeaeae;
	FONT: 11px Verdana, Tahoma, Helvetica;
...
{
	BACKGROUND: url(<{$_themePath}>images/settabletitlebgsel.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
...
{
	BACKGROUND: #fcfaf4 url(<{$_themePath}>images/gridtabletitlebg.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
	BORDER-TOP: 1px SOLID #fcfaf4;
	BORDER-BOTTOM: 1px SOLID #ddd6c7;
...
.topmenulinksdiv {
	...
	BACKGROUND:  #FFFFFF URL(<{$_themePath}>images/menuitembg.gif) REPEAT-X TOP LEFT;
	COLOR: #000000;
	FONT-FAMILY: Verdana, Arial, Helvetica;
	FONT-SIZE: 11px;
	PADDING-TOP: 0px;
...
.topnavselmenuitem {
CURSOR: pointer; float: left; height: 21px; margin: 0px; PADDING-TOP: 4px; PADDING-LEFT: 4px; BACKGROUND:  #FFFFFF URL(<{$_themePath}>images/menuhighlightbg.gif) REPEAT-X TOP LEFT; BORDER-RIGHT: 1px SOLID #c5bcae;
}
...
COLOR: red; CURSOR: pointer; float: left; height: 21px; margin: 0px; PADDING-TOP: 4px; PADDING-LEFT: 4px; BACKGROUND:  #FFFFFF URL(<{$_themePath}>images/menuhighlightbg.gif) REPEAT-X TOP LEFT; BORDER-RIGHT: 1px SOLID #c5bcae;
}
...
.dialogok {
	position: relative; float: left; background: URL(<{$_themePath}>images/icon_dialogok.png); WIDTH: 32px; HEIGHT: 32px; LEFT: -5px; TOP: -5px;
}
...
.dialogalert {
	position: relative; float: left; background: URL(<{$_themePath}>images/icon_dialogalert.png); WIDTH: 32px; HEIGHT: 32px; LEFT: -5px; TOP: -5px;
}
...
.dialogerror {
	position: relative; float: left; background: URL(<{$_themePath}>images/icon_dialogerror.png); WIDTH: 32px; HEIGHT: 32px; LEFT: -5px; TOP: -5px;
}
...
.gridtabletitlerow
{
	BACKGROUND: #FFFFFF url(<{$_themePath}>images/gridtabletitlebg.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
	BORDER-TOP: 1px SOLID #FFFFFF;
	BORDER-BOTTOM: 1px SOLID #d9cebc;
...
{
	BACKGROUND: #e2f8ff url(<{$_themePath}>images/gridtabletitlebgsel.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
	BORDER-TOP: 1px SOLID #FFFFFF;
...
{
	BACKGROUND: url(<{$_themePath}>images/gridtabletitlebgselhover.gif) REPEAT-X TOP LEFT;
	COLOR: #333333;
	FONT: 11px Verdana, Tahoma, Helvetica;
	BORDER-TOP: 1px SOLID #FFFFFF;
...
.gridirs
{
	...
	WIDTH: 303px;
	HEIGHT: 14px;
	BACKGROUND: URL(<{$_themePath}>images/icon_gridirs.gif) no-repeat;
...
.gridirsloading
{
	...
	WIDTH: 303px;
	HEIGHT: 14px;
	BACKGROUND: URL(<{$_themePath}>images/icon_gridirsloading.gif) no-repeat;
	BACKGROUND-POSITION: 1px 1px;
	BACKGROUND-COLOR: #FFFFFF;
	PADDING-RIGHT: 18px;
	VERTICAL-ALIGN: middle;
...
#widthwrapper {
	HEIGHT: 32px;
	BACKGROUND: #f2e9da url(<{$_themePath}>images/gridtoolbarbg.png) 50% 50% repeat-x;
/*	MARGIN-LEFT: 1px;*/
}
...
.rebartopspacer
{
	BACKGROUND: #f1ede4 URL(<{$_themePath}>images/rebartopbg.gif) REPEAT-X TOP LEFT;
	HEIGHT: 4px;
...
{
	HEIGHT: 21px;
	BACKGROUND: #727172 url(<{$_themePath}>images/menusectiondefbg.gif);
	COLOR: #EAEAEA;
	FONT-FAMILY: Verdana, Arial, Helvetica;
	FONT-SIZE: 11px;
	CURSOR: pointer;
...
.remenulinks
{
	...
	FONT-FAMILY: Verdana, Arial, Helvetica;
	FONT-SIZE: 11px;
	BACKGROUND: #727172 url(<{$_themePath}>images/remenulinksbg.gif);
	PADDING-TOP: 0px;
	PADDING-LEFT: 0px;
	BORDER-BOTTOM: 1px SOLID #efe8da;
}
...
.remenusection1
{
	BACKGROUND-IMAGE: url(<{$_themePath}>images/menusection1.gif);
}
...
.remenusection2
{
	BACKGROUND-IMAGE: url(<{$_themePath}>images/menusection2.gif);
}
.remenuline2
{
	BACKGROUND: #b6473d;
...
.remenusection3
{
	BACKGROUND-IMAGE: url(<{$_themePath}>images/menusection3.gif);
}
.remenuline3
{
	BACKGROUND: #6138a1;
...
.remenusection4
{
	BACKGROUND-IMAGE: url(<{$_themePath}>images/menusection4.gif);
}
.remenuline4
{
	BACKGROUND: #317525;
...
.multi
{
	BACKGROUND: #FFFFFF URL(<{$_themePath}>images/inputtextbg.gif) REPEAT-X TOP LEFT;
	COLOR: #000000;
	FONT-FAMILY: Verdana, Tahoma, Helvetica;
	FONT-SIZE: 11px;
	BORDER: 1px SOLID #bdac8e;
...
.swifttextdisabled
{
	BACKGROUND: #FFFFFF URL(<{$_themePath}>images/inputtextdisabledbg.gif) REPEAT-X TOP LEFT;
	COLOR: #808080;
...
.searchrule1
{
	BACKGROUND: #fbfaf5 url(<{$_themePath}>images/searchrulebg.gif) REPEAT-X TOP LEFT;
	BORDER: 1px SOLID #efe8da; COLOR: #333333; WIDTH: 100%;-moz-border-radius: 6px 6px 6px 6px; MARGIN-BOTTOM: 4px;
}

.searchrule0
{
	BACKGROUND: #eef6fc url(<{$_themePath}>images/searchrulebg2.gif) REPEAT-X TOP LEFT;
	BORDER: 1px SOLID #c1d8f7; COLOR: #333333; WIDTH: 100%;-moz-border-radius: 6px 6px 6px 6px; MARGIN-BOTTOM: 4px;
}

.searchrule2
{
	BACKGROUND: #fcd2d2 url(<{$_themePath}>images/searchrulebg3.gif) REPEAT-X TOP LEFT;
...
.logintext
{
	...
	PADDING: 2px 2px 3px 2px;
	MARGIN: 0px;
	BACKGROUND: URL(<{$_themePath}>images/icon_loginuser.gif) no-repeat;
...
.staffnavbar {
background: #ebddca url(<{$_themePath}>images/renavbarbg.gif) no-repeat bottom left;
}

#dashboardcontainer {
	BACKGROUND: #fff1c8 url(<{$_themePath}>images/dashboardbg.gif) no-repeat top left;
	HEIGHT: 79px;
	WIDTH: 100%;
	overflow: hidden;
}
...
.BarOption
{
	...
	BACKGROUND: #FFFDF8 URL(<{$_themePath}>images/icon_rightarrowblue.gif) no-repeat 9px 8px;
	CURSOR: pointer;
	COLOR: #000000;
	FONT-FAMILY: Verdana, Arial, Helvetica;
	FONT-SIZE: 11px;
...
.BarOption:hover
{
	BACKGROUND: #FFFFFF URL(<{$_themePath}>images/icon_rightarrowred.gif) no-repeat 9px 8px !important;
	COLOR: red;
}
