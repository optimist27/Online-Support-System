...
function elapsedTime_<{$_randomSuffix}>()
{
	...
	if (timer_<{$_randomSuffix}> < 3600)
	{
		...
		if (imagefetch_<{$_randomSuffix}> > <{$_clientRefresh}>) {
...
function doStatusLoop_<{$_randomSuffix}>() {
	...
	updateurl_<{$_randomSuffix}> = "<{$_swiftPath}>visitor/index.php?<{$_templateGroupPrefix}>/LiveChat/VisitorUpdate/UpdateFootprint/_time="+date1.getTime()+"/_randomNumber="+doRand_<{$_randomSuffix}>()+"/_url="+encodeURIComponent(window.location)+"/_isFirstTime="+encodeURIComponent(isfirsttime_<{$_randomSuffix}>)+"/_sessionID="+encodeURIComponent(sessionid_<{$_randomSuffix}>)+"/_referrer="+encodeURIComponent(document.referrer)+"/_resolution="+encodeURIComponent(screenWidth+"x"+screenHeight)+"/_colorDepth="+encodeURIComponent(colorDepth)+"/_platform="+encodeURIComponent(navigator.platform)+"/_appVersion="+encodeURIComponent(navigator.appVersion)+"/_appName="+encodeURIComponent(navigator.appName)+"/_browserCode="+encodeURIComponent(browsercode)+"/_browserVersion="+encodeURIComponent(browserversion)+"/_browserName="+encodeURIComponent(browsername)+"/_operatingSys="+encodeURIComponent(operatingsys)+"/_pageTitle="+encodeURIComponent(_finalPageTitle)+"/_hasNotes="+encodeURIComponent(hasnotes_<{$_randomSuffix}>)+"/_repeatVisit="+encodeURIComponent(repeatvisit_<{$_randomSuffix}>)+"/_lastVisitTimeline="+encodeURIComponent(lastvisittimeline_<{$_randomSuffix}>)+"/_lastChatTimeline="+encodeURIComponent(lastchattimeline_<{$_randomSuffix}>)+"/_isNewSession="+encodeURIComponent(isnewsession_<{$_randomSuffix}>)<{$_geoIPURL}>;
...
writeProactiveRequestData_<{$_randomSuffix}>(); writeInlineRequestData_<{$_randomSuffix}>(); elapsedTime_<{$_randomSuffix}>();
