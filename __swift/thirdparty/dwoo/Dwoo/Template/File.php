...
class Dwoo_Template_File extends Dwoo_Template_String
{
	...
	public static function templateFactory(Dwoo $dwoo, $resourceId, $cacheTime = null, $cacheId = null, $compileId = null, Dwoo_ITemplate $parentTemplate = null)
	{
		...
		/*
		 * ==============================
		 * Changed to solve problem with inheritance [VARUN]
		 * ==============================
		 */
		$_className = 'Dwoo_Template_File';
		if ($parentTemplate)
		{
			$_className = get_class($parentTemplate);
		}

		return new $_className($resourceId, $cacheTime, $cacheId, $compileId, $includePath);
	}
