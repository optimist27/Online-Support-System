 ...
 * @author Chris Corbyn
 */
class SwiftMailer_StreamFilters_StringReplacementFilterFactory
  implements SwiftMailer_ReplacementFilterFactory
{
  ...
  public function createFilter($search, $replace)
  {
    if (!isset($this->_filters[$search][$replace]))
    {
      ...
      $this->_filters[$search][$replace]
        = new SwiftMailer_StreamFilters_StringReplacementFilter($search, $replace);
    }
