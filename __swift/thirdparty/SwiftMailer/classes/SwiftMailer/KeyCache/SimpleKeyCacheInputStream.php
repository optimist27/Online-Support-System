 ...
 * @author Chris Corbyn
 */
class SwiftMailer_KeyCache_SimpleKeyCacheInputStream
  implements SwiftMailer_KeyCache_KeyCacheInputStream
{
   ...
   */
  public function write($bytes, SwiftMailer_InputByteStream $is = null)
  {
    $this->_keyCache->setString(
      $this->_nsKey, $this->_itemKey, $bytes, SwiftMailer_KeyCache::MODE_APPEND
      );
    if (isset($is))
    {
      $is->write($bytes);
