 ...
 * @author Chris Corbyn
 */
class SwiftMailer_KeyCache_DiskKeyCache implements SwiftMailer_KeyCache
{
   ...
   * @var SwiftMailer_KeyCache_KeyCacheInputStream
   * @access private
   */
  private $_stream;
   ...
   * @param SwiftMailer_KeyCache_KeyCacheInputStream $stream
   * @param string $path to save to
   */
  public function __construct(SwiftMailer_KeyCache_KeyCacheInputStream $stream, $path)
  {
    $this->_stream = $stream;
    $this->_path = $path;
   ...
   * @param string $string
   * @param int $mode
   * @throws SwiftMailer_IoException
  ...
  public function setString($nsKey, $itemKey, $string, $mode)
  {
    ...
    switch ($mode)
    {
      ...
      case self::MODE_APPEND:
        ...
        break;
      default:
        throw new SwiftMailer_SwiftMailerException(
  ...
  public function getInputByteStream($nsKey, $itemKey,
    SwiftMailer_InputByteStream $writeThrough = null)
  {
  ...
  private function _prepareCache($nsKey)
  {
    ...
    if (!is_dir($cacheDir))
    {
      if (!mkdir($cacheDir))
      {
        throw new SwiftMailer_IoException('Failed to create cache directory ' . $cacheDir);
      }
