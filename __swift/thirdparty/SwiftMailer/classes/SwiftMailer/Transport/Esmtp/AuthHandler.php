 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Transport_Esmtp_AuthHandler implements SwiftMailer_Transport_EsmtpHandler
{
  
  /**
   * Authenticators available to process the request.
   * @var SwiftMailer_Transport_Esmtp_Authenticator[]
   * @access private
   */
   ...
   * @param SwiftMailer_Transport_Esmtp_Authenticator[] $authenticators
   */
   ...
   * @return SwiftMailer_Transport_Esmtp_Authenticator[]
   */
   ...
   * @param SwiftMailer_Transport_SmtpAgent $agent to read/write
   */
  public function afterEhlo(SwiftMailer_Transport_SmtpAgent $agent)
  {
    if ($this->_username)
    {
      $count = 0;
   ...
   * Not used.
   */
  public function onCommand(SwiftMailer_Transport_SmtpAgent $agent,
  ...
  protected function _getAuthenticatorsForAgent()
  {
    ...
    throw new SwiftMailer_TransportException('Auth mode '.$mode.' is invalid');
  }
}
