 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Transport_EsmtpTransport
  extends SwiftMailer_Transport_AbstractSmtpTransport
  implements SwiftMailer_Transport_SmtpAgent
{
  
  /**
   * ESMTP extension handlers.
   * @var SwiftMailer_Transport_EsmtpHandler[]
   * @access private
   */
  ...
  private $_params = array(
    ...
    'blocking' => 1,
    'tls' => false,
    'type' => SwiftMailer_Transport_IoBuffer::TYPE_SOCKET
    );
  
  /**
   * Creates a new EsmtpTransport using the given I/O buffer.
   * @param SwiftMailer_Transport_IoBuffer $buf
   * @param SwiftMailer_Transport_EsmtpHandler[] $extensionHandlers
   * @param SwiftMailer_Events_EventDispatcher $dispatcher
   */
  public function __construct(SwiftMailer_Transport_IoBuffer $buf,
    array $extensionHandlers, SwiftMailer_Events_EventDispatcher $dispatcher)
  {
   ...
   * @param string $host
   * @return SwiftMailer_Transport_EsmtpTransport
   */
   ...
   * @param SwiftMailer_Transport_EsmtpHandler[] $handlers
   * @return SwiftMailer_Transport_EsmtpTransport
   */
   ...
   * @return SwiftMailer_Transport_EsmtpHandler[]
   */
  ...
  protected function _doHeloCommand()
  {
    ...
    if ($this->_params['tls'])
    {
      try
      {
        ...
        {
          throw new SwiftMailer_TransportException('Unable to connect with TLS encryption');
        }
