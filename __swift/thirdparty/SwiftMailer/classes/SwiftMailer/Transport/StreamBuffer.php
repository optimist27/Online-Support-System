 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Transport_StreamBuffer
  extends SwiftMailer_ByteStream_AbstractFilterableInputStream
  implements SwiftMailer_Transport_IoBuffer
{
   ...
   * @param SwiftMailer_ReplacementFilterFactory $replacementFactory
   */
  public function __construct(
    SwiftMailer_ReplacementFilterFactory $replacementFactory)
  {
