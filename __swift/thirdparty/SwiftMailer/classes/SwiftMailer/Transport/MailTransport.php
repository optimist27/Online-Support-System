 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Transport_MailTransport implements SwiftMailer_Transport
{
   ...
   * @param SwiftMailer_Transport_Log $log
   */
  public function __construct(SwiftMailer_Transport_MailInvoker $invoker,
    SwiftMailer_Events_EventDispatcher $eventDispatcher)
  {
   ...
   * 
   * @param string $params
   * @return SwiftMailer_Transport_MailTransport
   */
  ...
  private function _getReversePath(SwiftMailer_Mime_Message $message)
  {
