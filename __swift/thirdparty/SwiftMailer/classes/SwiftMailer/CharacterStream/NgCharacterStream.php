...
/*
 CharacterStream implementation using an array in SwiftMailer Mailer.
...
Class SwiftMailer_CharacterStream_NgCharacterStream
  implements SwiftMailer_CharacterStream
{

  /**
   * The char reader (lazy-loaded) for the current charset.
   * @var SwiftMailer_CharacterReader
   * @access private
   */
  private $_charReader;
   ...
   * @var SwiftMailer_CharacterReaderFactory
   * @access private
   */
   ...
   * The constructor
   *
   * @param SwiftMailer_CharacterReaderFactory $factory
   * @param unknown_type $charset
   */
  public function __construct(SwiftMailer_CharacterReaderFactory $factory,
    $charset)
  {
  ...
  public function setCharacterReaderFactory(
    SwiftMailer_CharacterReaderFactory $factory)
  {
    $this->_charReaderFactory = $factory;
  }

  /**
   * @see SwiftMailer_CharacterStream::flushContents()
   *
   */
  ...
  /**
   * @see SwiftMailer_CharacterStream::importByteStream()
   *
   * @param SwiftMailer_OutputByteStream $os
   */
  public function importByteStream(SwiftMailer_OutputByteStream $os)
  {
    $this->flushContents();
    $blocks=512;
    $os->setReadPointer(0);
  ...
  /**
   * @see SwiftMailer_CharacterStream::importString()
   *
   * @param string $string
   */
  ...
  /**
   * @see SwiftMailer_CharacterStream::read()
   *
   * @param int $length
   * @return string
   */
  public function read($length)
  {
  	...
  	{
      case SwiftMailer_CharacterReader::MAP_TYPE_FIXED_LEN:
      ...
      case SwiftMailer_CharacterReader::MAP_TYPE_INVALID:
      ...
      case SwiftMailer_CharacterReader::MAP_TYPE_POSITIONS:
        $end = $this->_currentPos + $length;
        $end = $end > $this->_charCount
          ?$this->_charCount
          :$end;
  ...
  /**
   * @see SwiftMailer_CharacterStream::readBytes()
   *
   * @param int $length
   * @return int[]
   */
  ...
  /**
   * @see SwiftMailer_CharacterStream::setPointer()
   *
  ...
  /**
   * @see SwiftMailer_CharacterStream::write()
   *
   * @param string $chars
   */
