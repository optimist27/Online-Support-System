 ...
 * @author Chris Corbyn
 */
class SwiftMailer_CharacterStream_ArrayCharacterStream
  implements SwiftMailer_CharacterStream
{
   ...
   * @param SwiftMailer_CharacterReaderFactory $factory for loading validators
   ...
   * @param SwiftMailer_OutputByteStream $os output stream to read from
   */
