 ...
 * @author Chris Corbyn
 */
class SwiftMailer_SmtpTransport extends SwiftMailer_Transport_EsmtpTransport
{
    ...
    $security = null)
  {
    call_user_func_array(
      array($this, 'SwiftMailer_Transport_EsmtpTransport::__construct'),
   ...
   * @param int $port
   * @param int $security
   * @return SwiftMailer_SmtpTransport
   */
