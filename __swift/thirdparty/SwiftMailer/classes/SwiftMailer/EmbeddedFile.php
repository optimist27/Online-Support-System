 ...
 * @author Chris Corbyn
 */
class SwiftMailer_EmbeddedFile extends SwiftMailer_Mime_EmbeddedFile
{
    ...
    $contentType = null)
  {
    call_user_func_array(
      array($this, 'SwiftMailer_Mime_EmbeddedFile::__construct'),
   ...
   * @param string $filename
   * @param string $contentType
   * @return SwiftMailer_Mime_EmbeddedFile
   */
