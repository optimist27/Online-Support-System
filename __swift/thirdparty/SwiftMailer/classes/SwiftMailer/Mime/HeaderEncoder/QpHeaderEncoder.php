...
/**
 * Handles Quoted Printable (Q) Header Encoding in SwiftMailer Mailer.
 * @package SwiftMailer
 * @subpackage Mime
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_HeaderEncoder_QpHeaderEncoder extends SwiftMailer_Encoder_QpEncoder
