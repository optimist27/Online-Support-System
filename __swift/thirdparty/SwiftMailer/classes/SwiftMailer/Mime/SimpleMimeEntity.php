 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_SimpleMimeEntity implements SwiftMailer_Mime_MimeEntity
{
  ...
  public function __construct(SwiftMailer_Mime_HeaderSet $headers,
    ...
    SwiftMailer_Mime_Grammar $grammar)
  {
  ...
  /**
   * Get the {@link SwiftMailer_Mime_HeaderSet} for this entity.
   * @return SwiftMailer_Mime_HeaderSet
   */
   ...
   * @param string $type
   * @return SwiftMailer_Mime_SimpleMimeEntity
   */
   ...
   * @return array of SwiftMailer_Mime_Entity
   */
  ...
  {
    return ($this->_body instanceof SwiftMailer_OutputByteStream)
   ...
   * {@link SwiftMailer_OutputByteStream}.
   * @param mixed $body
   ...
   * @return SwiftMailer_Mime_SimpleMimeEntity
   */
  public function setEncoder(SwiftMailer_Mime_ContentEncoder $encoder)
  {
  ...
  public function getBoundary()
  {
    ...
    {
      $this->_boundary = '_=_swiftmailer_v4_' . time() . uniqid() . '_=_';
    }
   ...
   * @throws SwiftMailer_RfcComplianceException
   * @return SwiftMailer_Mime_SimpleMimeEntity
   */
   ...
   * @param SwiftMailer_Mime_ContentEncoder $encoder
   */
  public function encoderChanged(SwiftMailer_Mime_ContentEncoder $encoder)
  {
    $this->_notifyEncoderChanged($encoder);
  }
    ...
    if (isset($this->_body) && empty($this->_immediateChildren))
    {
      ...
      else
      {
        ...
        $this->_cache->setString($this->_cacheKey, 'body', $body,
          SwiftMailer_KeyCache::MODE_WRITE
          );
      }
      $string .= $body;
    }
  ...
  /**
   * Write this entire entity to a {@link SwiftMailer_InputByteStream}.
   * @param SwiftMailer_InputByteStream
   */
  public function toByteStream(SwiftMailer_InputByteStream $is)
  {
    ...
    if (empty($this->_immediateChildren))
    {
      if (isset($this->_body))
      {
        ...
        else
        {
          ...
          if ($this->_body instanceof SwiftMailer_OutputByteStream)
          {
   ...
   * @return SwiftMailer_Mime_Grammar
   */
  ...
  protected function getRandomId()
  {
    ...
    {
      $id = $idLeft . '@swiftmailer.generated';
    }
  ...
  private function _readStream(SwiftMailer_OutputByteStream $os)
  {
    $string = '';
  ...
  private function _assertValidBoundary($boundary)
  {
    if (!preg_match(
      ...
      $boundary))
    {
      throw new SwiftMailer_RfcComplianceException('Mime boundary set is not RFC 2046 compliant.');
    }
  }
  ...
  private function _notifyEncoderChanged(SwiftMailer_Mime_ContentEncoder $encoder)
  {
    foreach ($this->_immediateChildren as $child)
    {
  ...
  private function _assertValidId($id)
  {
    ...
    {
      throw new SwiftMailer_RfcComplianceException(
        'Invalid ID given <' . $id . '>'
        );
    }
  }
