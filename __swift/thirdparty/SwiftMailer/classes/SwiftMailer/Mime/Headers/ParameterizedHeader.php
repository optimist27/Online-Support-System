 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_Headers_ParameterizedHeader
  extends SwiftMailer_Mime_Headers_UnstructuredHeader
  implements SwiftMailer_Mime_ParameterizedHeader
{
   ...
   * @param SwiftMailer_Encoder $paramEncoder, optional
   * @param SwiftMailer_Mime_Grammar $grammar
   */ 
  public function __construct($name, SwiftMailer_Mime_HeaderEncoder $encoder,
    SwiftMailer_Encoder $paramEncoder = null, SwiftMailer_Mime_Grammar $grammar)
  {
