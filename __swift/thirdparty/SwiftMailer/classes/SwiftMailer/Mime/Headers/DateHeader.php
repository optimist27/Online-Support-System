...
/**
 * A Date MIME Header for SwiftMailer Mailer.
 * @package SwiftMailer
 * @subpackage Mime
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_Headers_DateHeader extends SwiftMailer_Mime_Headers_AbstractHeader
{
   ...
   * <code>
   * <?php
   * $header = new SwiftMailer_Mime_Headers_DateHeader('Date', time());
   * ?>
   * </code>
