 ...
 * @author Chris Corbyn
 */
abstract class SwiftMailer_Mime_Headers_AbstractHeader implements SwiftMailer_Mime_Header
{
   ...
   */ 
  public function __construct(SwiftMailer_Mime_Grammar $grammar)
  {
   ...
   */
  public function setEncoder(SwiftMailer_Mime_HeaderEncoder $encoder)
  {
   ...
   * @return SwiftMailer_Mime_HeaderEncoder
   */
   ...
   * @param SwiftMailer_Mime_Grammar $grammar
   */
  public function setGrammar(SwiftMailer_Mime_Grammar $grammar)
  {
   ...
   * @param SwiftMailer_Mime_Header $header
   ...
   * @return string
   */
  protected function createPhrase(SwiftMailer_Mime_Header $header, $string, $charset,
    SwiftMailer_Mime_HeaderEncoder $encoder = null, $shorten = false)
  {
   ...
   * @return string
   */
  protected function encodeWords(SwiftMailer_Mime_Header $header, $input,
    $usedLength = -1)
  {
    $value = '';
