 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_Headers_MailboxHeader extends SwiftMailer_Mime_Headers_AbstractHeader
{
   ...
   */
  public function __construct($name, SwiftMailer_Mime_HeaderEncoder $encoder, SwiftMailer_Mime_Grammar $grammar)
  {
   ...
   *  'chris@swiftmailermailer.org' => 'Chris Corbyn',
   *  'mark@swiftmailermailer.org' //No associated personal name
   *  ));
   * ?>
   * </code>
   ...
   * <code>
   * <?php
   * $header = new SwiftMailer_Mime_Headers_MailboxHeader('From',
   *  array('chris@swiftmailermailer.org' => 'Chris Corbyn',
   *  'mark@swiftmailermailer.org' => 'Mark Corbyn')
   *  );
   * print_r($header->getNameAddressStrings());
   * // array (
   * // 0 => Chris Corbyn <chris@swiftmailermailer.org>,
   * // 1 => Mark Corbyn <mark@swiftmailermailer.org>
   * // )
   * ?>
   * </code>
   * @return string[]
   ...
   * @throws SwiftMailer_RfcComplianceException If invalid.
   * @access private
   */
