 ...
 * @author Chris Corbyn
 */
interface SwiftMailer_Mime_MimeEntity
  extends SwiftMailer_Mime_CharsetObserver, SwiftMailer_Mime_EncodingObserver
{
   ...
   * @return SwiftMailer_Mime_MimeEntity[]
   */
   ...
   * @param SwiftMailer_Mime_MimeEntity[] $children
   */
