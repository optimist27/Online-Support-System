 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_SimpleMessage extends SwiftMailer_Mime_MimePart
  implements SwiftMailer_Mime_Message
{
  ...
  public function __construct(SwiftMailer_Mime_HeaderSet $headers,
    SwiftMailer_Mime_ContentEncoder $encoder, SwiftMailer_KeyCache $cache, SwiftMailer_Mime_Grammar $grammar, $charset = null)
  {
   ...
   * @return SwiftMailer_Mime_SimpleMessage
   */
  ...
  /**
   * Attach a {@link SwiftMailer_Mime_MimeEntity} such as an Attachment or MimePart.
   * @param SwiftMailer_Mime_MimeEntity $entity
   * @return SwiftMailer_Mime_SimpleMessage
   */
  public function attach(SwiftMailer_Mime_MimeEntity $entity)
  {
   ...
   * @return SwiftMailer_Mime_SimpleMessage
   */
  public function detach(SwiftMailer_Mime_MimeEntity $entity)
  {
    $newChildren = array();
  ...
  /**
   * Attach a {@link SwiftMailer_Mime_MimeEntity} and return it's CID source.
   * This method should be used when embedding images or other data in a message.
   * @param SwiftMailer_Mime_MimeEntity $entity
   * @return string
   */
  public function embed(SwiftMailer_Mime_MimeEntity $entity)
  {
    $this->attach($entity);
  ...
  /**
   * Write this message to a {@link SwiftMailer_InputByteStream}.
  ...
  /** @see SwiftMailer_Mime_SimpleMimeEntity::_getIdField() */
