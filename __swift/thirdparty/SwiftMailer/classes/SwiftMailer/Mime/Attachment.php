 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_Attachment extends SwiftMailer_Mime_SimpleMimeEntity
{
   ...
   * @param SwiftMailer_FileStream $file
   * @param string $contentType optional
   * @return SwiftMailer_Mime_Attachment
   */
  public function setFile(SwiftMailer_FileStream $file, $contentType = null)
  {
