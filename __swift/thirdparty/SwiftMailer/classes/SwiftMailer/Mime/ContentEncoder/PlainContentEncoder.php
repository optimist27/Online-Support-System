...
/**
 * Handles binary/7/8-bit Transfer Encoding in SwiftMailer Mailer.
 * @package SwiftMailer
 * @subpackage Mime
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_ContentEncoder_PlainContentEncoder
  implements SwiftMailer_Mime_ContentEncoder
{
   ...
   * @param SwiftMailer_OutputByteStream $in
   * @param SwiftMailer_InputByteStream $out
   * @param int $firstLineOffset, ignored
