 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Mime_SimpleHeaderSet implements SwiftMailer_Mime_HeaderSet
{
   ...
   * 
   * @param SwiftMailer_Mime_HeaderFactory $factory
   * @param string $charset
   */
  public function __construct(SwiftMailer_Mime_HeaderFactory $factory,
    $charset = null)
  {
   ...
   * @param int $index
   */
  public function set(SwiftMailer_Mime_Header $header, $index = 0)
  {
  ...
  private function _storeHeader($name, SwiftMailer_Mime_Header $header, $offset = null)
  {
  ...
  private function _isDisplayed(SwiftMailer_Mime_Header $header)
  {
