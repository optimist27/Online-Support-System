 ...
 * @author Chris Corbyn
 */
class SwiftMailer_DependencyContainer
{
   ...
   * @return SwiftMailer_DependencyContainer
   */
   ...
   * @param string $itemName
   * @return mixed
   * @throws SwiftMailer_DependencyException If the dependency is not found
   * @see register()
   */
  public function lookup($itemName)
  {
    ...
    {
      throw new SwiftMailer_DependencyException(
