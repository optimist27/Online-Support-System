 ...
 */
class SwiftMailer_Plugins_DecoratorPlugin
  implements SwiftMailer_Events_SendListener, SwiftMailer_Plugins_Decorator_Replacements
{
   ...
   * of {@link SwiftMailer_Plugins_Decorator_Replacements}.
   * 
   ...
   * </code>
   * 
   * When using an instance of {@link SwiftMailer_Plugins_Decorator_Replacements},
   * the object should return just the array of replacements for the address
   * given to {@link SwiftMailer_Plugins_Decorator_Replacements::getReplacementsFor()}.
   * 
   * @param mixed $replacements
   */
  public function __construct($replacements)
  {
    if (!($replacements instanceof SwiftMailer_Plugins_Decorator_Replacements))
    {
   ...
   * {@link SwiftMailer_Plugins_Decorator_Replacements} then the call will be
  ...
  {
    if ($this->_replacements instanceof SwiftMailer_Plugins_Decorator_Replacements)
    {
