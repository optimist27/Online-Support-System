 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Plugins_PopBeforeSmtpPlugin
  implements SwiftMailer_Events_TransportChangeListener, SwiftMailer_Plugins_Pop_Pop3Connection
{
   ...
   * @param string $cypto as "tls" or "ssl"
   * 
   * @return SwiftMailer_Plugins_PopBeforeSmtpPlugin
   */
   ...
   * 
   * @param SwiftMailer_Plugins_Pop_Pop3Connection $connection
   */
  public function setConnection(SwiftMailer_Plugins_Pop_Pop3Connection $connection)
  {
   ...
   * 
   * @param SwiftMailer_Transport
   */
  public function bindSmtp(SwiftMailer_Transport $smtp)
  {
   ...
   * 
   * @throws SwiftMailer_Plugins_Pop_Pop3Exception if connection fails
   */
  public function connect()
  {
    ...
    else
    {
      if (!isset($this->_socket))
      {
        ...
        {
          throw new SwiftMailer_Plugins_Pop_Pop3Exception(
