 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Plugins_ThrottlerPlugin
  extends SwiftMailer_Plugins_BandwidthMonitorPlugin
  implements SwiftMailer_Plugins_Sleeper, SwiftMailer_Plugins_Timer
{
   ...
   * @param SwiftMailer_Plugins_Sleeper $sleeper (only needed in testing)
   * @param SwiftMailer_Plugins_Timer $timer (only needed in testing)
   */
  public function __construct($rate, $mode = self::BYTES_PER_MINUTE,
    SwiftMailer_Plugins_Sleeper $sleeper = null, SwiftMailer_Plugins_Timer $timer = null)
  {
    $this->_rate = $rate;
    $this->_mode = $mode;
