 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Plugins_LoggerPlugin
  implements SwiftMailer_Events_CommandListener, SwiftMailer_Events_ResponseListener,
  SwiftMailer_Events_TransportChangeListener, SwiftMailer_Events_TransportExceptionListener,
  SwiftMailer_Plugins_Logger
{
  ...
  public function exceptionThrown(SwiftMailer_Events_TransportExceptionEvent $evt)
  {
    ...
    $evt->cancelBubble();
    throw new SwiftMailer_TransportException($message);
  }
